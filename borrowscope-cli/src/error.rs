...
pub fn print_error(error: &CliError) {
    eprintln!();
    eprintln!("{}", "━".repeat(70).red());
    eprintln!("{} {}", error.category().red().bold(), "✗".red().bold());
    eprintln!("{}", "━".repeat(70).red());
    eprintln!();
    ...
    while let Some(err) = source {
        ...
        eprintln!();
        eprintln!("  {} {}", "↳".yellow(), "Caused by:".yellow().bold());
    ...
    if let Some(suggestion) = error.suggestion() {
        eprintln!();
        eprintln!("{}", "─".repeat(70).bright_black());
        eprintln!();
        eprintln!("  {} {}", "💡".green(), "Suggestion:".green().bold());
