# Section 199: Cross-Platform Builds

## Learning Objectives

By the end of this section, you will:
- Master cross-platform builds for BorrowScope
...
Cross-Platform Builds is the final step in bringing BorrowScope to users. This section covers everything needed to package, distribute, and maintain BorrowScope as a production-ready application.
...
- Cross-Platform Builds is critical for user adoption
...
This section covered cross-platform builds with comprehensive examples and best practices for successfully deploying and maintaining BorrowScope in production.
