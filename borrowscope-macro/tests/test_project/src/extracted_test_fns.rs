// Auto-extracted from test files for type-info generation
...
#[trace_borrow]
pub fn test_fn_v2() -> i32 {
        let x = Rc::new(42);
        *x
    }

#[trace_borrow]
pub fn test_fn_v3() -> (i32, i32) {
        let x = Rc::new(42);
        let y = Rc::clone(&x);
        (*x, *y)
    }
...
#[trace_borrow]
pub fn test_fn_v4() -> String {
        let x = Rc::new(String::from("hello"));
        (*x).clone()
    }

#[trace_borrow]
pub fn test_fn_v5() -> usize {
...
#[trace_borrow]
pub fn test_fn_v6() -> Option<i32> {
        let x = Rc::new(Some(42));
        *x
    }

#[trace_borrow]
pub fn test_fn_v7() -> std::result::Result<i32, String> {
...
#[trace_borrow]
pub fn example_dup2<T>(value: T) -> T {
        let x = value;
        x
    }

#[trace_borrow]
pub fn example_2_dup2<T>(value: T) -> T {
        let x = value;
        x
    }

#[trace_borrow]
pub fn example_3_dup2<T>(value: T) -> T {
        let x = value;
        x
    }

#[trace_borrow]
pub fn example_4_dup2<T, U>(t: T, u: U) -> (T, U) {
        let x = t;
        let y = u;
        (x, y)
    }
...
#[trace_borrow]
pub fn example_5_dup2<T: Clone>(value: T) -> T {
        let x = value.clone();
        x
    }

#[trace_borrow]
pub fn example_6_x2<T>(value: T) -> T
    where
...
#[trace_borrow]
pub fn example_7_x2<'a>(x: &'a str) -> &'a str {
        let y = x;
        y
    }

#[trace_borrow]
pub fn example_8_x2<'a, 'b>(x: &'a str, _y: &'b str) -> &'a str {
        let z = x;
        z
    }

#[trace_borrow]
pub fn example_9_x2<const N: usize>(arr: [i32; N]) -> [i32; N] {
        let x = arr;
        x
    }

#[trace_borrow]
pub fn example_10_x2<T>(value: Option<T>) -> Option<T> {
        let x = value;
        x
    }

#[trace_borrow]
pub fn example_11_x2<T, E>(value: std::result::Result<T, E>) -> std::result::Result<T, E> {
        let x = value;
        x
    }
